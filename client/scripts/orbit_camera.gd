...
## ничем. Довод против прежнего устройства записан у CAB_KEYS: рукоятки уехали на
## цифры именно потому, что буквы считались занятыми ходьбой — а в кабине они не
## заняты ничем.
