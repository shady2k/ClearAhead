...
//
// Перебор по всем точкам — осознанно простой: на карте одной станции их
// тысячи, и пространственный индекс здесь был бы формой без потребителя. Он
// приезжает вместе с чанковым хранилищем, где выборка идёт прямоугольниками
// (ClearAhead-kmo).
